...
QString MainWindow::codificar(QString varbinario) { //Codificación de Hamming tiene por parámetro
    ...
    int M1 = (int)varbinario.at(0).toAscii()-48, M2 = (int)varbinario.at(1).toAscii()-48, M3 =(int) varbinario.at(2).toAscii()-48,
            M4 =(int) varbinario.at(3).toAscii()-48, M5 = (int)varbinario.at(4).toAscii()-48, M6 = (int)varbinario.at(5).toAscii()-48,
            M7 = (int)varbinario.at(6).toAscii()-48, M8 = (int)varbinario.at(7).toAscii()-48;
...
int MainWindow::distanciaMin(QString cad1, QString cad2) {
    ...
    for (int i=0; i<len; i++)
        cont += XOR(cad1.at(i).toAscii()-48,cad2.at(i).toAscii()-48);
...
QString MainWindow::decodificar(QString cadena) {
    ...
    for (int i=0; i<12; i++)
        cadCodif[i] = cadena.at(i).toAscii()-48;
